...
LastEditTime: 2021-01-23 22:03:08
'''
import decimal
import pandas as pd
import numpy as np
...
def init_vertex(drug_data, id_to_idx, vertex, year):
    ...
    nums = list(drug_data[(drug_data['SubstanceName'] == 'Heroin') & (drug_data['YYYY'] == year)]['DetectionRate'])
    for id, num in zip(ids,nums):
        vertex[id_to_idx[id]]=0.5*num
...
if __name__ == "__main__":
    ...
    drug_data['DetectionRate'] = drug_data['DrugReports']/drug_data['TotalDrugReportsCounty'] 
